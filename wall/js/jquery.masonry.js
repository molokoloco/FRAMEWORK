...
;(function($){  
  ...
  $.fn.masonry = function(options, callback) { 
    ...
    var msnry = {
	  ...
	  setAnimate : function(animate) { opts.animate = animate; }, // mlklc
      ...
      arrange : function($wall, opts, props) {
        ...
        $.fn.applyStyle = (opts.animate ) ? $.fn.animate : $.fn.css; // props.masoned && 
        ...
        $wall.applyStyle( wallCSS); //, $.extend(true,[],opts.animationOptions) ); // mlklc ^^
