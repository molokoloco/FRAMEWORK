            ...
            return this.each(function() {  
                ...
                $targets.each(function() {
                    var $target = $(this),
                        ...
                        xRadius = (options.xRadius ? options.xRadius : xCenter),
                        yRadius = (options.yRadius ? options.yRadius : yCenter),
                        params = {
                    ...
                    if (options.rotateTargets)
                        $target.rotate((Math.atan2(params.top-yCenter, params.left-xCenter)+1.5707963267948966)+'rad'); // 1.57 == 90° rotation to keep tangent
                    angle += increase;
                });
            });
         },
