...
a[1];c.debug&&console.log("moveToViewport(view)",a);var b=0,b=a==v?r:a*f;u(b)}};c.checkHash&&C();return this};b.fn.scrollScreen.defaults={debug:"console"in n&&!1,checkHash:!1,scrollScreenZone:"scrollScreenZone",scrollScreen:"scrollScreen"}})(jQuery,window,document);
